...
//		System.out.println("Origin text box element found");
		return element;
	}
...
//		System.out.println("Enter origin city as " + origin);
	}
...
//		System.out.println("Destination text box element found");
		return element;
	}
...
//		System.out.println("Enter destination city as " + destination);
	}
...
//		System.out.println("Enter departure date as " + date);
	}
...
//		System.out.println("Enter return date as " + date);
	}
...
//		System.out.println("Navigate to flights tab");
	}
	/**
...
//		System.out.println("Clicked on Advanced Options link");
	}
	/**
...
//		System.out.println("Clicked non-stop check box");
	}
	/**
	 * Select flight class
	 * @param driver
...
//		System.out.println("Select flight class as " + flightClass);
	}
	/**
...
//		System.out.println("Select flight adults as " + flightAdults);
	}
